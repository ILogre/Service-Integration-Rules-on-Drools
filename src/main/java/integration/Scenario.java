...
public class Scenario {
	...
	public static void main(String[] args) throws Exception {
		...
		String requirementName = "Needs";
		spy = new Spy();
		bus = new ESB();
		mailbox = new HashMap<Message, Answer>();
		//scenario1(catalogName,dashboardName,requirementName);
		//scenario2(catalogName,dashboardName,requirementName);
		//scenario3(catalogName,dashboardName,requirementName);
		//scenario4(catalogName,dashboardName,requirementName);
		//scenario5(catalogName,dashboardName,requirementName);
		//scenario6(catalogName,dashboardName,requirementName);
		//scenario7(catalogName,dashboardName,requirementName);
		scenario8(catalogName,dashboardName,requirementName);
		clean(catalogName, dashboardName);
	}
	
	private static void scenario1(String catalogName, String dashboardName,String requirementName){
		int step = 0;
	...
	private static void scenario2(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario3(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario4(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario5(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario6(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario7(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
	...
	private static void scenario8(String catalogName, String dashboardName,String requirementName){
		int step = 0;
		System.out.println("[Scenario - Step " + ++step
				+ "]: Declare a Catalog");
		bus.handle(new DeclareCatalogMsg(catalogName));
